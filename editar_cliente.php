...
<div class="C-base" style="margin-left:0 auto;">
    ...
    <form method="POST" action="services/editar_cliente_banco.php">
        ...
        <p><label for="celular">Celular:</label>
            <input type="text" name="celular" id="celular" value="<?php echo $row_usuario['celular'];?>"/></p>
        ...
        <p><label for="endereco">Endereço:</label>
            <input type="text" name="endereco" id="endereco" value="<?php echo $row_usuario['endereco'];?>"/></p>


        <p><label for="numero">Número:</label>
            <input type="text" name="numero" id="numero" value="<?php echo $row_usuario['numero'];?>"/></p>


        <p><label for="observacao">Observação:</label>
            <textarea name="observacao" id="observacao"> <?php echo $row_usuario['observacao'];?> </textarea></p>
